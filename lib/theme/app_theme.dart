...
class AppTheme {
  ...
  /// Magenta da identidade visual Villamor — usado APENAS como acento.
  ...
  static ThemeData get light {
    final cs = ColorScheme.fromSeed(
      ...
      // Overrides para um background mais neutro (não tão rosado)
  ...
  // ── Builder central ───────────────────────────────────────────────────────
  static ThemeData _buildTheme(ColorScheme cs, {required Brightness brightness}) {
    final isLight = brightness == Brightness.light;

    // Cor da superfície do AppBar e do fundo das abas
    final appBarBg = isLight ? Colors.white : const Color(0xFF1F2937);
    final appBarFg = isLight ? const Color(0xFF1C1B1F) : const Color(0xFFE5E7EB);

    // Cor das abas: primary no fundo claro, magenta suave no dark
    final tabLabelColor = cs.primary;
    final tabUnselectedColor = isLight
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        filled: true,
        fillColor: isLight ? const Color(0xFFF9FAFB) : const Color(0xFF111827),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        backgroundColor: isLight ? const Color(0xFF1C1B1F) : const Color(0xFFE5E7EB),
